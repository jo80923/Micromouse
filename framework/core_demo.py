...
from strategy import StrategyJaxRendezvous
from controller import COREController
from socket import *

mazeMap = Map(16, 16)
totalMice = 4
mazeMap.readFromFile('/home/jackson/Development/robot/Micromouse/mazes/2012japan-ef.txt')
id = gethostname()[1:]
...
micromouse.addTask(StrategyJaxRendezvous(micromouse, totalMice - 1, initPoint))#minus one as this is numNeighbors
micromouse.run()
